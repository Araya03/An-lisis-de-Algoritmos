...
Sin embargo, para observar el comportamiento (tiempo de ejecución en función de la cantidad de datos) de los diferentes algoritmos y estructuras de datos, se deben seguir los siguientes pasos:
